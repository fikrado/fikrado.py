#!/usr/bin/python2
#coding=utf-8
#Codded By yahye abdirahman fikrado
#Editing My Script Will Not Make You A Coder
#Facebook : fikrado  
#Whatsapp : +252634048063
#somaliland hacker
#Alone Coder 
...
\x1b[1;94m➣  Github   : https://github.com/fikrado
\x1b[1;94m➣  Whatsapp : +2526404806
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(1)
            ...
            os.system('xdg-open https://www.https://www.youtube.com/channel/UCfDGS-Ni69XsxStragOA29A')
    else:
        print "\033[1;97mACCESS DENIED"
        os.system('xdg-open https://www.https://www.youtube.com/channel/UCfDGS-Ni69XsxStragOA29A')
def login():
	...
	try:
		...
		jalan(' \033[1;97m   ✧ \033[1;97m👉 : \033[1;97mfikrado somali hacker Of Facebook' ) 
